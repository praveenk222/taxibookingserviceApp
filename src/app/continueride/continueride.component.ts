...
@Component({
  selector: 'app-continueride',
  templateUrl: './continueride.component.html',
  styleUrls: ['./continueride.component.scss'],
})
export class ContinuerideComponent  implements OnInit {
